...
// );
  ...
  const shareUrl1 = `https://warpcast.com/~/compose?text=${shareText1}&embeds[]=https://follower-count.vercel.app/frames`;

  // const shareUrl2 = `https://warpcast.com/~/compose?text=${shareText2}&embeds[]=https://follower-count.vercel.app/frames${
  //   fid ? `?userfid=${fid}` : ""
  // }`;
